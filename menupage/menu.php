...
<body>
    ...
    <div class="topBar">
        <div class="topBar_left">
            <div class="userImg">
                <img src="./recursos/perfil.png" alt="User Profile" class="userProfile">
            </div>
            <div class="userName">
        ...
        <div class="topBar_right">
            <div class="coinsPurse rounded">
                ...
                <div class="icon">
                    <img src="./recursos/coin.png" alt="Coin Icon" class="coinIcon">
                </div>
            </div>
            <div class="storeBtn rounded">
                ...
                <div class="icon">
                    <img src="./recursos/tienda.png" alt="Store Icon" class="storeIcon">
                </div>
            </div>
        </div>
    </div>
